...
Press = {
    ...
    _bindEvents: function() {
        ...
        this.menuButton.off('click.press').on('click.press', function(e) {
        ...
        this.topbarMenuButton.off('click.press').on('click.press', function(e) {
        ...
        this.menu.off('click.press').on('click.press', 'a', function(e) {
            var link = $(this),
            item = link.parent(),
        ...
        this.menu.off('mouseenter.press').on('mouseenter.press','> li > a', function(e) {
        ...
        this.profileButton.off('click.press').on('click.press', function(e) {
        ...
        this.topbar.off('click.press').on('click.press','.topbar-items > li > a', function(e) {
            var link = $(this),
            item = link.parent(),
            submenu = link.next();
        ...
        $this.topbarItems.children('.search-item').off('click.press').on('click.press', function(e) {
            $this.topbarLinkClick = true;
        });

        $(document.body).off('click.press').on('click.press', function() {
